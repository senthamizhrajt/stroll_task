...
/// ```
/// {@end-tool}
class NewFadeInImage extends StatefulWidget {
  ...
  @override
  State<NewFadeInImage> createState() => _NewFadeInImageState();
}

class _NewFadeInImageState extends State<NewFadeInImage> {
  ...
  Image _image({
    ...
    return Image(
      ...
      opacity: opacity,
      width: !isPlaceHolder ? widget.width : widget.placeHolderWidth ?? widget.width,
      height: !isPlaceHolder ? widget.height : widget.placeHolderHeight ?? widget.height,
      fit: isPlaceHolder ? widget.placeholderFit : fit,
...
class _AnimatedFadeOutFadeInState extends ImplicitlyAnimatedWidgetState<_AnimatedFadeOutFadeIn> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: <Widget>[
        widget.target,
        Align(child: widget.placeholder),
      ],
    );
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Animation<double>>('targetOpac ity', _targetOpacityAnimation));
